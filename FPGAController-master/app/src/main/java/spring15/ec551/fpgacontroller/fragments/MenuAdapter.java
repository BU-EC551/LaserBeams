...
public class MenuAdapter extends ArrayAdapter<String> {
    ...
    /** To prevent any attempts to load a null user list,
     *  the constructor will check the list and only assign if it
     *  isn't null. */
     ...
     *  assign the new values to the fragment list, then invoke a refresh
     *  call.
     */
